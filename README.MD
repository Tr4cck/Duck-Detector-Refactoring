...
> 
In addition, the project contains helper modules such as dashboard, settings, deviceinfo, and simcard to provide data aggregation, user controls, and device/subscription context visualization.
# 📱 Compatibility
